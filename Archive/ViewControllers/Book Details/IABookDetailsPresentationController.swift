//
//  IABookDetailsPresentationController.swift
//  Archive
//
...
class IABookDetailsPresentationController: UIPresentationController {
    ...
    override func containerViewWillLayoutSubviews () {
        UIView.animateWithDuration(0.25){ ()->() in
            ...
            self.presentedView()!.addConstraint(NSLayoutConstraint(item: self.presentedView()!  , attribute: .Width, relatedBy: .Equal, toItem: self.presentedView()!, attribute: .Height, multiplier: 1.0, constant: 0))
            self.presentedView()!.addConstraint(NSLayoutConstraint(item: self.presentedView()!  , attribute: .Width, relatedBy: .Equal, toItem: nil, attribute: .NotAnAttribute, multiplier: 0.0, constant: 0.8*min(UIScreen.mainScreen().bounds.width,UIScreen.mainScreen().bounds.height)))
