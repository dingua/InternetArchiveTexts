...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Archive/FRHyperLabel.framework"
  install_framework "Pods-Archive/MBProgressHUD.framework"
  install_framework "Pods-Archive/ReachabilitySwift.framework"
  install_framework "Pods-Archive/SSZipArchive.framework"
